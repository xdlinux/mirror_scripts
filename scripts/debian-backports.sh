...
#SYNC_SERVER="rsync://debian.ustc.edu.cn/backports.org/"
#SYNC_SERVER="rsync://debian6.ustc.edu.cn/backports.org/"
SYNC_SERVER="rsync://ftp.v6.coe.psu.ac.th/debian-backports"
LOG_FILE="debian-backports_$(date +%Y%m%d-%H).log"
