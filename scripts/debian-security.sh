...
#SYNC_SERVER="rsync://www.anheng.com.cn/debian-security/"
#SYNC_SERVER="rsync://debian.ustc.edu.cn/debian-security/"
SYNC_SERVER="rsync://mirrors6.ustc.edu.cn/debian-security/"
LOG_FILE="debian-security_$(date +%Y%m%d-%H).log"
...
rsync -6 -av --exclude *ia64* --exclude *alpha* --exclude *hppa* --exclude *s390* --exclude *source* --exclude *.orig.tar.gz --exclude *.diff.gz --exclude *.dsc $SYNC_SERVER $SYNC_FILES >> $SYNC_LOGS/$LOG_FILE
