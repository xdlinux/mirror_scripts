...
SYNC_FILES="/srv/ftp/fedora/release/13/Everything"
SYNC_LOCK="$SYNC_HOME/fedora_i386_everyting.lck"

SYNC_REPO=(i386 x86_64 source)

# Set the rsync server to use
# Only official public mirrors are allowed to use rsync.archlinux.org
#SYNC_SERVER=rsync://mirror.yandex.ru/fedora/linux/releases/13/Everything
#SYNC_SERVER=rsync://oss6.ustc.edu.cn/pub/fedora/releases/13/Everything

SYNC_SERVER=rsync://mirror6.ustc.edu.cn/fedora/releases/13/Everything
# Set the format of the log file name
# This example will output something like this: sync_20070201-8.log
LOG_FILE="everything_i386_$(date +%Y%m%d-%H).log"
