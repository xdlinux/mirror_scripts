...
REPONAME="rpmfusion_free"
SYNC_LOGS="$SYNC_HOME/logs/fedora"
SYNC_FILES="/srv/ftp/fedora/rpmfusion/free/release/13/Everything"
...
SYNC_SERVER=rsync://mirror.yandex.ru/fedora/rpmfusion/free/fedora/releases/13/Everything
