...
SYNC_FILES="/srv/ftp/fedora/releases/14/Everything"
SYNC_LOCK="$SYNC_HOME/fedora_everyting_14.lck"
...
SYNC_SERVER=rsync://mirror6.bjtu.edu.cn/fedora/releases/14/Everything

# Set the format of the log file name
# This example will output something like this: sync_20070201-8.log
LOG_FILE="everything_14_$(date +%Y%m%d-%H).log"
